...
public class MarioEvalFunctionUNC implements IObjectiveFunction {
	...
	public MarioEvalFunctionUNC() throws IOException {
        ...
        public MarioEvalFunctionUNC(String GANPath, String GANDim) throws IOException {
		// set up process for GAN
		...
		try {
			...
			if(info.computeDistancePassed() < LEVEL_LENGTH) { // Did not beat level
                ...
                return  - info.computeDistancePassed() / LEVEL_LENGTH
						...
						- levelStats.numGaps * EvaluationInfo.gapWeight;
			}
